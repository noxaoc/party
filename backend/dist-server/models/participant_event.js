...
exports.ParticipantEvent = void 0;
...
function makeParticipantEvent() {
  ...
  function list(rec, respHdl) {
    ...
    if (!(0, _utils.checkIsNilFld)(rec.filter, 'fkParticipant', respHdl)) return;
    var rs = (0, _record.makeRecordSet)([['pkID', 'n'], ['fkParty', 'n'], ['fkEvent', 'n'], ['fkParticipant', 'n'], ['role', 's'], ['price', 'n'], ['comment', 's'], ['nameEvent', 's']]);
    _dbschema.DBParticipantEvent.list(rs, rec.filter, rec.ord, rec.nav, respHdl);
  }
  ...
  */
  function init(_ref, respHdl) {
    ...
    var rs = (0, _record.makeRecordSet)([['fkParty', 'n'], ['fkEvent', 'n'], ['fkParticipant', 'n'], ['role', 's'], ['price', 'n'], ['comment', 's']]);
  ...
  function read(rec, respHdl) {
    ...
    var rs = (0, _record.makeRecordSet)([['pkID', 'n'], ['fkParty', 'n'], ['fkEvent', 'n'], ['fkParticipant', 'n'], ['role', 's'], ['price', 'n'], ['comment', 's']]);
    _dbschema.DBParticipantEvent.read(rs, rec, respHdl);
  }
  ...
  */
  function remove(rec, respHdl) {
    ...
    _dbschema.DBParticipantEvent.remove(rec, respHdl);
  }
  ...
  */
  function insert(rec, respHdl) {
    if (!(0, _utils.checkFkParty)(rec, respHdl)) return;
    _dbschema.DBParticipantEvent.insert(rec, respHdl);
  }
...
exports.ParticipantEvent = ParticipantEvent;