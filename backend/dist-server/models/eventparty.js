...
function makeEventParty() {
  ...
  function list(rec, respHdl) {
    ...
    var rs = (0, _record.makeRecordSet)([['pkID', 'n'], ['name', 's'], ['description', 's'], ['evTypeName', 's'], ['dtStart', 't'], ['fkTypeEvent', 'n'], ['fkParty', 'n'], ['price', 'n']]);
  ...
  */
  ...
  function read(rec, respHdl) {
    ...
    var rs = (0, _record.makeRecordSet)([['pkID', 'n'], ['name', 's'], ['description', 's'], ['evTypeName', 's'], ['dtStart', 't'], ['fkParty', 'n'], ['price', 'n']]);
