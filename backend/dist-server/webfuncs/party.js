...
var list = function list(req, res, next) {
  ...
  (0, _response.getResult)(_party.Party.list, req.body, res);
};
...
var read = function read(req, res, next) {
  console.log(req.body);
  (0, _response.getResult)(_party.Party.read, req.body, res);
};
...
var remove = function remove(req, res, next) {
  console.log(req.body);
  (0, _response.getResult)(_party.Party.remove, req.body, res);
};
...
var insert = function insert(req, res, next) {
  console.log(req.body);
  (0, _response.getResult)(_party.Party.insert, req.body, res);
};
...
var update = function update(req, res, next) {
  console.log(req.body);
  (0, _response.getResult)(_party.Party.update, req.body, res);
};
...
var init = function init(req, res, next) {
  console.log(req.body);
  (0, _response.getResult)(_party.Party.init, req.body, res);
};
exports.init = init;