...
export default (props = {}) => {
  ...
  /* Navbar навигационная панель появится вверху когда экран станет меньше размера middle ( md ) о чем 
  говорит установленное свойство d-md-none, а при размерах middle и выше Navbar скрыт
      ...
      <CSSTransition timeout={300} in={show} classNames="sidebar-transition">
        <SimpleBar className={`collapse ${showClass} sidebar d-md-block bg-primary text-white`}>
          <div className="sidebar-inner px-4 pt-3">
            {/* карточка пользователя скрыта для экранов middle и выше, при уменьшении экрана появится в левой верхнем углу */}
